...
bool loadKeymapFile() {
    ...
    if (stonesenseState.ssConfig.immersive_mode) {
        ...
        actionkeymap_default[ALLEGRO_KEY_W] = action_decrY;
        actionkeymap_default[ALLEGRO_KEY_S] = action_incrY;
        actionkeymap_default[ALLEGRO_KEY_A] = action_decrX;
        actionkeymap_default[ALLEGRO_KEY_D] = action_incrX;
